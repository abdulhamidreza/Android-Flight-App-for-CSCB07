...
public class Driver {
  ...
  public static List<String> getFlights(String date, String origin, String destination)
    ...
    /*
     * String flightNum = "AC213"; Date departure =
     * dateTime.parse("2016-11-29 11:30"); Date arrival =
     * dateTime.parse("2016-11-29 15:45"); String airline = "Air Canada"; double
     * price = 630.99;
     * 
     * String oneFlightFormatted = String.format("%s;%s;%s;%s;%s;%s;%.2f",
     * flightNum, dateTime.format(departure), dateTime.format(arrival), airline,
     * origin, destination, price); flights.add(oneFlightFormatted);
     */
  ...
  public static List<String> getItineraries(String date, String origin, String destination) {
     ...
     * dateTime.format(departure1), dateTime.format(arrival1), airline1, origin,
     * stopover); String flight2Formatted = String.format("%s;%s;%s;%s;%s;%s",
     * flightNum2, dateTime.format(departure2), dateTime.format(arrival2),
     * airline2, stopover, destination); String oneItineraryFormatted =
